...
#define WIFI_SSID "BT-J9A3MG"
#define WIFI_PSWD "JbMPuvbRu4ibD4"
...
//#else
#define I2S_MIC_SERIAL_CLOCK GPIO_NUM_13 // SCK correct
//#endif

#define I2S_MIC_LEFT_RIGHT_CLOCK GPIO_NUM_15 //WS correct
...
*/
#define I2S_SPEAKER_SERIAL_CLOCK GPIO_NUM_14 // correct
#define I2S_SPEAKER_LEFT_RIGHT_CLOCK GPIO_NUM_12  //correct 
#define I2S_SPEAKER_SERIAL_DATA GPIO_NUM_27 //correct

// command recognition settings
#define COMMAND_RECOGNITION_ACCESS_KEY "CFQMXOYSDQSQYJQE2X2ZEZMH52LETPE7"
